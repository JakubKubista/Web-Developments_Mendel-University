<?php
// source: C:\xampp\htdocs\chat_nette\app/config/config.neon 
// source: C:\xampp\htdocs\chat_nette\app/config/config.local.neon 

class Container_a483bac85a extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\xampp\htdocs\chat_nette\app',
			'wwwDir' => 'C:\xampp\htdocs\chat_nette\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => 'C:\xampp\htdocs\chat_nette\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\chat_nette\app'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\xampp\htdocs\chat_nette\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\chat_nette\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		return new Container_a483bac85a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('C:\xampp\htdocs\chat_nette\app/../temp/cache/latte');
...
final class Container_a483bac85a_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{

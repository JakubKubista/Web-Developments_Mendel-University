<?php
// source: C:\xampp\htdocs\chat_nette\app\presenters/templates/Homepage/profile.latte

class Template3186deb1425f16fa23db4a788204c2ba extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('ebc126eb0c', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb9146841ba5_content')) { function _lb9146841ba5_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="navigation">
    <div id="nav1">
        <ul>
<?php $_b->templates['ebc126eb0c']->renderChildTemplate("../components/global/printRooms.latte", $template->getParameters()) ?>
        </ul>

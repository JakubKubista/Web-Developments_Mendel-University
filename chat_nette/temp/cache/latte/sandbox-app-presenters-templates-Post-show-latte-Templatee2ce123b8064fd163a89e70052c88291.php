<?php
// source: C:\xampp\htdocs\sandbox\app\presenters/templates/Post/show.latte

class Templatee2ce123b8064fd163a89e70052c88291 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('2879a78f7b', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lbc47775e035_content')) { function _lbc47775e035_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb1a5969cb32_title')) { function _lb1a5969cb32_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v

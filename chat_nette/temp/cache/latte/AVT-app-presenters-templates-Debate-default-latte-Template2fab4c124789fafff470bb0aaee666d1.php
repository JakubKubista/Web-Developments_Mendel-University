<?php
// source: C:\xampp\htdocs\AVT\app\presenters/templates/Debate/default.latte

class Template2fab4c124789fafff470bb0aaee666d1 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1e1e95371f', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb74f5418261_content')) { function _lb74f5418261_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb4900119f30_title')) { function _lb4900119f30_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?>    <h1>Můj blog</h1>
<?php
}}

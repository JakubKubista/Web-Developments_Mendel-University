<?php
// source: C:\xampp\htdocs\wa_chat\app\presenters/templates/Debate/../components/room/printAdministrators.latte

class Templateab0022ff5e234d4839897a9a370afe56 extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3b1c7a37f5', 'html')
;

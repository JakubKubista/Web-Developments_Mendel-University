...
?>	<script src="<?php echo Latte\Runtime\Filters::escapeHtml(Latte\Runtime\Filters::safeUrl($basePath), ENT_COMPAT) ?>/js/jquery-2.1.3.min.js"></script>     
        <script>
            var $basePath2 = <?php echo Latte\Runtime\Filters::escapeJs($basePath) ?>;
        </script>
...
<?php Latte\Macros\BlockMacrosRuntime::callBlock($_b, 'field', $template->getParameters()) ?>
        </div>
...
<?php Latte\Macros\BlockMacrosRuntime::callBlock($_b, 'content', $template->getParameters()) ?>
        ...
        <div id="footer">
            <div class="left">&copy; 2015 Jakub Kubišta - WA</div>		

...
class Container_9b81dae466 extends Nette\DI\Container
{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\sandbox\app'));
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\sandbox\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=quickstart', 'root', NULL, array('lazy' => TRUE));
	...
	{
		return new Container_9b81dae466_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_9b81dae466_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
